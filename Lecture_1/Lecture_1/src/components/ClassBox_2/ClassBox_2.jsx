...
class ClassBox_2 extends React.Component {
    render() {
        return (
            <div className=" w-1/2 bg-blue-900 hover:bg-slate-600 text-white transition-all px-5 py-4 mt-5 mr-5 ml-2 rounded-xl "> 
